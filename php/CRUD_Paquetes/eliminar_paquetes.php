<?php
/*En este archivo se recibe a traves de un POST el paquete que se desa eliminar y se guarda en la variable "$producto" una vez obtenida la variable se procede a hacer la peticion a la BD con la query delete y se analiza si se realizo correctamente se le avisa que fue correcto y se redirecciona a la pagina de modificar, en caso contrario se le notifica el error y se regresa a la pagina de "Modificar_Paquetes.html"
*/
	include ("../conexion.php");
	$producto = $_POST["producto"];
	$link = Conectarse();

	$query ="DELETE FROM paquetes WHERE paquetes.productos = '$producto'";
